...
<%--</ul>--%>
<head>
    <jsp:include page="hokhongcutru-js.jsp"/>
</head>
<div class="box">
    <div class="box-body">
        <h1 class="main-title">Thông tin tìm kiếm</h1>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group form-label-top isExactly">
                        ...
                        <div class="input-group">
                            <input class="form-control" type="text" placeholder="Nhập tên chủ hộ" name="hoTenChuHo" id="hoTenChuHo"
                                   value="${hoTenChuHo}" autocomplete="off">
                            <div class="input-group-addon">
                                <input type="checkbox" name="timChinhXacTenChuHo" id="timChinhXacTenChuHo" value="true"
                                       <c:if test="${timChinhXacTenChuHo == true}">checked="checked"</c:if>
                                       class="append-control"> <label for="timChinhXacTenChuHo">Tìm chính xác</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group form-label-top">
                        ...
                        <input class="form-control" type="text" placeholder="Nhập CMND/CCCD/ĐDCN" name="cmndChuHo" id="cmndChuHo"
                               oninput="this.value=this.value.replace(/[^0-9]/g,'');"
                            value="${cmndChuHo}" autocomplete="off">
                    </div>
                </div>
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group form-label-top">
